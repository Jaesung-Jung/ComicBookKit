...
class CmdExtract
{
  ...
  public:
    ...
    bool ExtractCurrentFile(Archive &Arc,size_t HeaderSize,bool &Repeat,uint ReadLength);
    static void UnstoreFile(ComprDataIO &DataIO,int64 DestUnpSize,uint ReadLength);
};
